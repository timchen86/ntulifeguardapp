...
class ntulgUser(models.Model):
    ...
    stage_no = models.DecimalField(max_digits=10)#, help_text="cm")
    ...
    identify_number = models.CharField(verbose_name=u"身分證字號(id)", help_text=u"外籍人士請填居留證號碼(.........)", max_length=INPUT_MAX, validators=[RegexValidator(r'(^[a-zA-Z][12][0-9]{8}$|^[a-zA-Z][cCdD][0-9]{8}$)'),MinLengthValidator(10),MaxLengthValidator(10)])
...
class ntulgOldUserForm(ModelForm):
    def __init__(self, *args, **kwargs):
        super(ntulgUserForm, self).__init__(*args, **kwargs)
        self.fields["stage_no"].label = "救生班期數(stage no.)"
...
class ntulgOldUserForm(ntulgUserForm):
    def __init__(self, *args, **kwargs):
        super(ntulgUserForm, self).__init__(*args, **kwargs)
        self.fields["stage_no"].label = "救生班期數(stage no.)"

class ntulgNewUserForm(ntulgUserForm):
    def __init__(self, *args, **kwargs):
        super(ntulgUserForm, self).__init__(*args, **kwargs)
        self.fields["stage_no"].label = "報名救生班期數(stage no.)"
